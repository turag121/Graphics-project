...
void Intro() {
    ...
    renderBitmapString(-0.5f, 0.7f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "American International University-Bangladesh");
    renderBitmapString(-0.35f, 0.6f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "GRAPHICS PROJECT");
    renderBitmapString(-0.4f, 0.5f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "SECTION: I");
    renderBitmapString(-0.1f, 0.5f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "GROUP: 3");
    renderBitmapString(-0.4f, 0.3f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "SHADES OF CIVILIZATION");
    renderBitmapString(-0.5f, 0.20f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "COURSE TEACHER:   NOBORANJAN DEY");
    renderBitmapString(-0.5f, 0.10f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "23-50652-1  -  TAHMID TAMJID TURAG");
    renderBitmapString(-0.5f, 0.00f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "23-50638-1  -  USWATUL HASAN NIBIR");
    renderBitmapString(-0.5f, -0.10f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "23-50624-1  -  ANUJA SARKER");
    renderBitmapString(-0.5f, -0.2f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "22-49555-3  -  ASHADULLAH HIL GALIB");
